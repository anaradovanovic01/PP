...
public class ClassDeclWithoutMethods extends ClassDecl {
    ...
    public ClassDeclWithoutMethods (String className, Extends Extends, VarDeclList VarDeclList, ConstructorDeclList ConstructorDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassDeclWithoutMethods(\n");
