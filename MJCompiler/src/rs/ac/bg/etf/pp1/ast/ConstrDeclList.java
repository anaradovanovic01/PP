...
public class ConstrDeclList extends ConstructorDeclList {

    private ConstructorDeclList ConstructorDeclList;
    private ConstructorDecl ConstructorDecl;

    public ConstrDeclList (ConstructorDeclList ConstructorDeclList, ConstructorDecl ConstructorDecl) {
